...
public class Sorts {
    ...
    private static <T extends Comparable<? super T>> void mergeSortHelper(T[] arr, 
                                    int start, int end, List<SortEvent<T>> events) {
        if (end - start <= 1) {
            return;
        }
    ...
    private static <T extends Comparable<? super T>> void merge(T[] arr, 
                        int start, int mid, int end, List<SortEvent<T>> events) {
    ...
    private static <T extends Comparable<? super T>> void quickSortHelper(T[] arr, 
                                        int low, int high, List<SortEvent<T>> events) {
        if (low < high) {
    ...
    private static <T extends Comparable<? super T>> int pivotGetter(T[] arr, 
                                    int low, int high, List<SortEvent<T>> events) {
    ...
    private static <T extends Comparable<? super T>> int medianOfThree(T[] arr, 
                                    int low, int high, List<SortEvent<T>> events) {
    ...
    /**
     * Events the array according to the events generated by the sort
     * @param <T> the carrier type of the array
    ...
    private static <T extends Comparable<? super T>> void heapify(T[] arr, 
                                int n, int i, List<SortEvent<T>> events) {
        int largest = i; 
        int left = 2 * i + 1; 
        int right = 2 * i + 2; 
